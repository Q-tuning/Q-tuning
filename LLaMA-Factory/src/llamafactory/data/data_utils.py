...
def get_dataset_module(dataset: Union["Dataset", "DatasetDict"], data_args: "DataArguments") -> "DatasetModule":
    ...
    dataset_module["train_dataset"] = InfoBatch(dataset_module["train_dataset"], data_args.data_method, data_args.data_ratio)
