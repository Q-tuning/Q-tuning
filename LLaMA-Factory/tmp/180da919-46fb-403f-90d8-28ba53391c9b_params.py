...
models = [
    dict(
        ...
        path=
        '/mnt/public/gpfs-jd/data/wangshaobo/Data_Token_Pruning/checkpoints/alpaca/qw2.5-7b/qw2.5-3b-3e_sft/data_ratio=30/token_ratio=50/random_random_5e-5',
        run_cfg=dict(num_gpus=1),
        type='opencompass.models.vllm.VLLM'),
]
work_dir = '/mnt/public/gpfs-jd/data/wangshaobo/Data_Token_Pruning/checkpoints/alpaca/qw2.5-7b/qw2.5-3b-3e_sft/data_ratio=30/token_ratio=50/random_random_5e-5/results/ARC_c_ppl/20250831_174810'
