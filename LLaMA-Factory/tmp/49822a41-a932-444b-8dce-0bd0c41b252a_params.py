...
models = [
    dict(
        ...
        path=
        '/mnt/public/gpfs-jd/data/wangshaobo/Data_Token_Pruning/checkpoints/wizard/llama2-7b/data_ratio_50/token_ratio_100/random_random_1e-4',
        run_cfg=dict(num_gpus=2),
        type='opencompass.models.vllm.VLLM'),
]
work_dir = '/mnt/public/gpfs-jd/data/wangshaobo/Data_Token_Pruning/checkpoints/wizard/llama2-7b/data_ratio_50/token_ratio_100/random_random_1e-4/results/gsm8k_gen/20250913_221824'
