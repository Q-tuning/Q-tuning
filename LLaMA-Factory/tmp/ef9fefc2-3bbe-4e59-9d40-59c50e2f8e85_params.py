...
models = [
    dict(
        ...
        path=
        '/mnt/public/gpfs-jd/data/wangshaobo/Data_Token_Pruning/checkpoints/alpaca/qw2.5-7b/qw2.5-7b-1e_sft/data_ratio=30/token_ratio=50/random_rho_5e-5',
        run_cfg=dict(num_gpus=1),
        type='opencompass.models.vllm.VLLM'),
]
work_dir = '/mnt/public/gpfs-jd/data/wangshaobo/Data_Token_Pruning/checkpoints/alpaca/qw2.5-7b/qw2.5-7b-1e_sft/data_ratio=30/token_ratio=50/random_rho_5e-5/results/race_ppl/20250831_223350'
