...
models = [
    dict(
        abbr='longest_random_5e-5_hf-vllm',
        batch_size=8,
        ...
        path=
        '/mnt/public/gpfs-jd/data/wangshaobo/Data_Token_Pruning/checkpoints/alpaca/qw2.5-7b/data_ratio=30/token_ratio=50/longest_random_5e-5',
        run_cfg=dict(num_gpus=1),
        type='opencompass.models.vllm.VLLM'),
]
work_dir = '/mnt/public/gpfs-jd/data/wangshaobo/Data_Token_Pruning/checkpoints/alpaca/qw2.5-7b/data_ratio=30/token_ratio=50/longest_random_5e-5/results/ARC_c_ppl/20250831_165720'
