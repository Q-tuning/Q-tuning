...
models = [
    dict(
        abbr='random_sample_sparsevlm_5e-5_hf-vllm',
        batch_size=8,
        ...
        path=
        '/mnt/public/gpfs-jd/data/wangshaobo/Data_Token_Pruning/checkpoints/wizard/mistral-7b/data_ratio_50/token_ratio_70/random_sample_sparsevlm_5e-5',
        run_cfg=dict(num_gpus=2),
        type='opencompass.models.vllm.VLLM'),
]
work_dir = '/mnt/public/gpfs-jd/data/wangshaobo/Data_Token_Pruning/checkpoints/wizard/mistral-7b/data_ratio_50/token_ratio_70/random_sample_sparsevlm_5e-5/results/mmlu_gen/20250916_174511'
