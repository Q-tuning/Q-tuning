...
models = [
    dict(
        ...
        path=
        '/mnt/public/gpfs-jd/data/wangshaobo/Data_Token_Pruning/checkpoints/alpaca/qw2.5-7b/qw2.5-7b-3e_sft/data_ratio_30/token_ratio_70/wise_wise_1e-4',
        run_cfg=dict(num_gpus=4),
        type='opencompass.models.vllm.VLLM'),
]
work_dir = '/mnt/public/gpfs-jd/data/wangshaobo/Data_Token_Pruning/checkpoints/alpaca/qw2.5-7b/qw2.5-7b-3e_sft/data_ratio_30/token_ratio_70/wise_wise_1e-4/results/squad20_gen/20250909_200520'
